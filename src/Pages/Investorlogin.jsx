            ...
            <div className='w-full h-full bg-white flex flex-col p-20 justify-between'>
              ...
              <div className='w-full flex flex-col'>
                ...
                <div className='w-full flex flex-col my-4'>
                  <button className='w-full text-white my-2 font-semibold bg-blue-400 rounded-md p-4 text-center flex items-center justify-center'>Log in</button>
                  <button className='w-full text-black my-2 font-semibold bg-orange-400 rounded-md 
                  p-4 text-center flex items-center justify-center'><Link to="/investor">Register</Link></button>
                </div>
                ...
                <div className='w-full text-[#060606] my-2 font-semibold bg-white
                 border-2 border-black rounded-md p-4 text-center flex  justify-center items-center'>
              ...
              <div className='w-full flex items-center justify-center'>
                ...
                underline text-black underline-offset-2'><Link to="/investor">Sign up</Link></span> </p>
              </div>
            </div>
          </div>
        </div>
