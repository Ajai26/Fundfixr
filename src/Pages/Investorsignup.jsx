            ...
            <div className='w-full h-full bg-white flex flex-col p-20 justify-between'>
              ...
              <div className='w-full flex flex-col'>
                <div className='w-full flex flex-col justify-center items-center mb-10'>
                  ...
                  <p className='text-sm text-[25px]  text-orange-400 mb-2 leading-6'>Get Matched With High Potential  </p>
                  <p className='text-sm text-[25px]  text-orange-400 mb-2 '> Startup & Start Investing</p>
                </div>
                <div className='w-full flex flex-col'>
                  <input type='email'
                    placeholder='Email'
